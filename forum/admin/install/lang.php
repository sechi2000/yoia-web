...
$lang = array(
	...
	'ftp_err_no_ext'					=> "Your server does not support using FTP storage, or the directory permissions are incorrect. Please contact your hosting provider.",
	'ftp_err_no_ssl'					=> "Your server does not support using SSL-FTP storage, or the directory permissions are incorrect. Please contact your hosting provider.",
	'ftp_err_no_sftp'					=> "Your server does not support using SFTP storage, or the directory permissions are incorrect. Please contact your hosting provider.",

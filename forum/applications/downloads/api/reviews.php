...
class reviews extends CommentController
{
	 ...
	 * Class
	 */
	protected string $class = 'IPS\downloads\File\Review';
	 ...
	 * @apireturn		\IPS\downloads\File\Review
	 * @return Response
	 */
	public function GETitem( int $id ): Response
	{
		...
		{
			throw new Exception( 'INVALID_ID', '2D305/1', 404 );
		}
	}
	...
	public function POSTindex(): Response
	{
		...
		{
			throw new Exception( 'INVALID_ID', '2D305/2', 403 );
		}
		...
		if ( $this->member )
		{
			...
			{
				throw new Exception( 'NO_PERMISSION', '2D305/A', 403 );
			}
			$author = $this->member;
		}
		else
		{
			if ( Request::i()->author )
			{
				...
				if ( !$author->member_id )
				{
					throw new Exception( 'NO_AUTHOR', '1D305/3', 404 );
				}
			}
			else
			{
				...
				{
					throw new Exception( 'NO_AUTHOR', '1D305/3', 400 );
				}
			}
		}
	...
	public function POSTitem( int $id ): Response
	{
		try
		{
			...
			{
				throw new Exception( 'NO_AUTHOR', '1D305/7', 400 );
			}
		}
		catch ( OutOfRangeException $e )
		{
			throw new Exception( 'INVALID_ID', '2D305/6', 404 );
		}
	}
	...
	public function DELETEitem( int $id ): Response
	{
		try
		{
			...
			{
				throw new Exception( 'NO_PERMISSION', '2D305/C', 403 );
			}
			$object->delete();
		...
		{
			throw new Exception( 'INVALID_ID', '2D305/9', 404 );
		}
	}

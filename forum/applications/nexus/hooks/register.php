...
class nexus_hook_register extends _HOOK_CLASS_
{
	...
	protected function manage()
	{
		...
		else if ( \IPS\Member::loggedIn()->canAccessModule( \IPS\Application\Module::get( 'nexus', 'subscriptions' ) ) and \IPS\Settings::i()->nexus_subs_enabled and \IPS\Settings::i()->nexus_subs_register )
		{

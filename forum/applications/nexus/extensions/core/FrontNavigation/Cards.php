 ...
 */
class Cards extends FrontNavigationAbstract
{	
	/**
	...
	{
		return Member::loggedIn()->language()->addToStack('client_cards');
	}
	...
	{
		return Url::internal( "app=nexus&module=clients&controller=cards", 'front', 'clientscards' );
	}
	...
	{
		return Dispatcher::i()->application->directory === 'nexus' and Dispatcher::i()->module and Dispatcher::i()->module->key === 'clients' and Dispatcher::i()->controller == 'cards';
	}
}
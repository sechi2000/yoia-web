...
class comments extends CommentController
{
	 ...
	 * Class
	 */
	protected string $class = 'IPS\blog\Entry\Comment';
	 ...
	 * @apireturn		\IPS\blog\Entry\Comment
	 * @return Response
	 */
	public function GETitem( int $id ): Response
	{
		...
		{
			throw new Exception( 'INVALID_ID', '2B301/1', 404 );
		}
	}
	...
	public function POSTindex(): Response
	{
		...
		try
		{
			$entry = Entry::load( Request::i()->entry );
		}
		catch ( OutOfRangeException $e )
		{
			throw new Exception( 'INVALID_ID', '2B301/2', 403 );
		}
		...
		if ( $this->member )
		{
			...
			{
				throw new Exception( 'NO_PERMISSION', '2B301/8', 403 );
			}
			$author = $this->member;
		}
		else
		{
			if ( Request::i()->author )
			{
				...
				if ( !$author->member_id )
				{
					throw new Exception( 'NO_AUTHOR', '1B301/3', 404 );
				}
			}
			else
			{
				...
				{
					throw new Exception( 'NO_AUTHOR', '1B301/3', 400 );
				}
			}
		}
		...
		{
			throw new Exception( 'NO_CONTENT', '1B301/4', 403 );
		}
	...
	public function POSTitem( int $id ): Response
	{
		try
		{
			...
			{
				throw new Exception( 'NO_PERMISSION', '2B301/9', 403 );
			}
			...
			{
				throw new Exception( 'NO_AUTHOR', '1B301/6', 400 );
			}
		}
		catch ( OutOfRangeException $e )
		{
			throw new Exception( 'INVALID_ID', '2B301/5', 404 );
		}
	}
	...
	public function DELETEitem( int $id ): Response
	{
		try
		{
			...
			{
				throw new Exception( 'NO_PERMISSION', '2B301/A', 403 );
			}
			$object->delete();
		...
		{
			throw new Exception( 'INVALID_ID', '2B301/7', 404 );
		}
	}

<?php
/**
 * @brief		Editor Extension: ClubPage
...
/**
 * Editor Extension: ClubPage
 */
class ClubPage extends EditorLocationsAbstract
{
	/**
	...
	{
		return Page::load( $id1 )->club->canRead( $member );
	}
